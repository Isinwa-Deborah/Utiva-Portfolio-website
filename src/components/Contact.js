		...
		<>
			...
			<section id="contact">
				<div className="ml-20 mr-20 mb-10">
					<div className="flex">
						<h3 className="font-secondary font-medium text-2xl mt-10">
							Contact
						</h3>
						...
						<div className=" mt-10 shadow-lg rounded-md bg-green-100">
							<div>
								...
								<div className="p-5 flex gap-5">
									...
									<a
										href="https://www.facebook.com/isinwaiheme.deborah"
										className="mt-1"
									>
										Deborah Isinwa-Iheme
									</a>
								</div>
								...
								<div className="p-5 flex gap-5">
									...
									<a
										href="https://www.linkedin.com/in/deborah-isinwa-iheme-ab037923a/"
										className="mt-1"
									>
										Benin-city, Nigeria
									</a>
								...
								<div className="p-5 flex gap-5">
									...
									<a
										href="https://twitter.com/IsinwaDeborah?t=nQA686gt-P1iQ7mnLGp1Aw&s=08"
										className="mt-1"
									>
										@Isinwa-Deborah
									</a>
								...
								<div className="p-5 flex gap-5">
									...
									<a href="https://github.com/Isinwa-Deborah" className="mt-1">
										Isinwa-Deborah
									</a>
								</div>
							</div>
						...
						<div className="mt-10 bg-gray-100 p-10 rounded-md mr-20 shadow-lg">
							<p>
								...
								<span className="font-bold">
									discussing new projects, opportunities in tech world,
									partnerships
								</span>
							...
							>
								<div className="flex gap-9 mt-10">
									...
									<input
										...
										className="border rounded-md border-green-400 py-2 px-6"
									/>
								</div>
								...
								<div className="flex gap-10 mt-5">
									...
									<input
										...
										className="border rounded-md border-green-400 px-6 py-2"
									/>
								</div>
								...
								<div className="flex gap-4 mt-5">
									...
									<textarea
										...
										className="border rounded-md border-green-400 px-8 py-5 resize-none"
									></textarea>
								</div>

								<button
									className="mt-10 font-tertiary font-semibold py-2 rounded-md px-5 text-lg bg-shadeGreen text-white hover:bg-gray-600"
									type="submit"
								>
									Submit
								</button>
